...
def run_replicate_unpaired_DESeq2(counts, sample_group,outfile):
    # 必须加，否则转换数据类型会报错
    pandas2ri.activate()
    ...
    dds = DESeq2.DESeqDataSetFromMatrix(countData=countData_r, colData=colData_r, design=Formula("~ Group"))
